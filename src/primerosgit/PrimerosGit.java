...
public class PrimerosGit {
    ...
    public static void menu(int index, Scanner scanner){
        ...
        switch (index) {
            ...
            case 24:
                ...
                System.out.println(ejercicio24((int)valor1, (int)valor2, (int)valor3));
    ...
    public static String ejercicio24(int a, int b, int c){
    ...
    public static void ejercicio28(){
        for (int i = 1; i <= 10; i++) {
            switch (i) {
                ...
                case 4:
                    System.out.println("4: El de abajo");
                    break;
                default:
                   System.out.println(i+": Mensaje del default");
            }
        }
    }
